      ...
      <div className="container mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/services#full-service" className="text-gray-300 hover:text-white transition-colors">
                  Full Service ($350+)
                </Link>
              </li>
              <li>
                <Link href="/services#interior-detailing" className="text-gray-300 hover:text-white transition-colors">
                  Interior Detail ($250+)
                </Link>
              </li>
              <li>
                <Link href="/services#exterior-detailing" className="text-gray-300 hover:text-white transition-colors">
                  Exterior Detail ($200+)
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/services#clay-bar-treatment" className="text-gray-300 hover:text-white transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <span className="text-gray-300">Mobile Service - Omaha and Surrounding Areas</span>
              </li>
        ...
        <div className="border-t border-zinc-800 pt-8 mt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Detail Omaha. All rights reserved.
            </p>
