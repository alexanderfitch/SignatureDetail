  ...
  return (
    <section className="py-16 md:py-24 bg-gradient-to-r from-red-900/80 to-black" ref={ref}>
      <div className="container mx-auto px-4 text-center">
        ...
        >
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6">Ready to Experience the Difference?</h2>
          <p className="text-xl text-gray-200 mb-8">
            Schedule your appointment today and let our expert team transform your vehicle.
          </p>
